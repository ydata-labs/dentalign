/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv cloudflare-env.d.ts` (hash: 92b2aa8eb5d586697456c368aa0a3d12)
...
declare namespace Cloudflare {
	...
	interface Env {
		...
		NEXT_PUBLIC_PINTEREST: string;
		NEXT_PUBLIC_GOOGLE_PLUS: string;
		NEXT_PUBLIC_BLOGSPOT: string;
		...
		NEXT_PUBLIC_REVIEW_COUNT: string;
		NEXT_PUBLIC_REVIEW_RATING: string;
		ASSETS: Fetcher;
	}
}
